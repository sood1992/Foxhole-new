...
<body>
        ...
        <div class="main-content">
            ...
            <div class="content-wrapper">
                ...
                <div class="page-header">
                    <div>
                        <h1 class="page-title"><i class="fas ri-chat-3-line"></i> Team Chat</h1>
                        <p class="page-description">Communicate with your team in real-time</p>
                    </div>
                </div>
                    ...
                    <div class="chat-main">
                        ...
                        <div class="chat-input">
                            <form class="chat-input-form" id="chatForm">
                                <input type="text" id="messageInput" placeholder="Type a message..." autocomplete="off" required class="form-control">
    ...
    document.querySelectorAll('.channel-item').forEach(item => {
        item.addEventListener('click', function() {
            ...
            document.getElementById('channelName').innerHTML = '<i class="fas fa-' + (currentChannelType === 'team' ? 'users' : 'folder') + '"></i> ' + channelName;
