                                    ...
                                    <div class="form-group">
                                        <label style="display: flex; align-items: center; cursor: pointer; padding: 12px; background: var(--bg-tertiary); border-radius: var(--radius-md); margin-bottom: 12px;">
                                            ...
                                            <div style="flex: 1;">
                                                ...
                                                <div style="font-size: 12px; color: var(--text-secondary);">Receive system and user notifications via email</div>
                                            </div>
                                        </label>
                            ...
                            <div class="dashboard-card">
                                ...
                                <div class="card-body">
                                    <div style="font-size: 13px; line-height: 1.6; color: var(--text-secondary);">
                                        ...
                                        <p><strong>Notifications:</strong> Control how you receive system alerts and updates.</p>
                                        <p><strong>Email Digest:</strong> Get a summary of system activity at your preferred frequency.</p>
                                ...
                                <div class="card-body">
                                    <div style="font-size: 13px; line-height: 1.6;">
                                        <p style="margin-bottom: 12px;">
                                            <a href="email-config.php" style="color: var(--primary); text-decoration: none;">
                                                <i class="fas fa-envelope-open-text"></i> Email Configuration
                                            </a>
                                        </p>
                                        <p style="margin-bottom: 12px;">
                                            <a href="users.php" style="color: var(--primary); text-decoration: none;">
                                                <i class="fas fa-users-cog"></i> User Management
                                            </a>
                                        </p>
                                        <p style="margin-bottom: 12px;">
                                            <a href="master-dashboard.php" style="color: var(--primary); text-decoration: none;">
